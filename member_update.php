 ...
 <TABLE align="center" class="table1" >
  ...
  <tr class="table1_tr3">
    ...
    <td>
      ...
      ?>
     <FORM action="action/member_update_do.php" name="form1" method="post">
     <table align="center"  width=50% class="table2">
  <tr class="table2_tr1"><td colspan=2 align="center">修改会员信息</td></tr>
  <tr>
    <td>用户名：</td>
